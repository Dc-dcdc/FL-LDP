...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        dataset = torchvision.datasets.ImageFolder('dataset_train',
														 transform=trans_mnist)
        dataset_test={i: list() for i in range(0,7)}
        for i in range(0,7):
             dataset_test[i] = torchvision.datasets.ImageFolder(('dataset_test/{}'.format(i)),
														transform=trans_mnist)

        dataset_share1 = torchvision.datasets.ImageFolder('dataset_share1',
                                                        transform=trans_mnist)
        dataset_share2 = torchvision.datasets.ImageFolder('dataset_share2',
                                                        transform=trans_mnist)
